    ...
    public partial class SeedData : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.AlterColumn<DateTime>(
                ...
                table: "Orders",
                nullable: false,
                defaultValue: new DateTime(2020, 9, 24, 23, 16, 5, 876, DateTimeKind.Local).AddTicks(5522),
                oldClrType: typeof(DateTime),
                oldType: "datetime2",
                oldDefaultValue: new DateTime(2020, 9, 24, 16, 48, 12, 738, DateTimeKind.Local).AddTicks(8699));
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "HomeTitle", "Day la trang chu cua eShop" },
                    { "HomeKeyWord", "Day la tu khoa cua eShop" },
                    { "HomeDescription", "Day la mo ta cua eShop" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2020, 9, 24, 23, 16, 5, 891, DateTimeKind.Local).AddTicks(87), 10000m, 20000m, null });
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.AlterColumn<DateTime>(
                ...
                type: "datetime2",
                nullable: false,
                defaultValue: new DateTime(2020, 9, 24, 16, 48, 12, 738, DateTimeKind.Local).AddTicks(8699),
                oldClrType: typeof(DateTime),
                oldDefaultValue: new DateTime(2020, 9, 24, 23, 16, 5, 876, DateTimeKind.Local).AddTicks(5522));
        }
    }
}
